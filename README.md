# Поддержка этой версии SDK заканчивается 31.12.2021, SDK будет работать, но больше не будет обновляться, рекомендуем перейти на новую версию: https://github.com/cloudpayments/CloudPayments-SDK-iOS
