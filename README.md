# Поддержка этой версии SDK заканчивается 31.12.2021, SDK продолжит работать, но не будет обновляться, рекомендуем перейти на новую версию: https://github.com/cloudpayments/CloudPayments-SDK-iOS
