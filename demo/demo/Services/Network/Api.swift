...
extension NetworkService {
    ...
    func charge(cardCryptogramPacket: String, cardHolderName: String, amount: Int, completion: @escaping (Result<TransactionResponse>) -> Void) {
    ...
    func auth(cardCryptogramPacket: String, cardHolderName: String, amount: Int, completion: @escaping (Result<TransactionResponse>) -> Void) {
